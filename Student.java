public class Student {  String name,stuNo;
    ...
    public void calcAvarage() {
        this.avarage = (((this.fizik.verbalNote*0.20) + (this.fizik.note*0.80)) + (this.mat.note*0.80) +(this.mat.verbalNote*0.20))+(this.kimya.verbalNote*0.20)+(this.kimya.note*0.80)/ 3;
    }
